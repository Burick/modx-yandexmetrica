...
$sitename = $modx->getOption('analytics_sitename'); // TODO: что за хрень

//Get the amount of days
$days = $modx->getOption('analytics_days', null, 7); // период
...
$lexicon = $modx->lexicon->fetch(
    $prefix = 'yametrica.',
    $removePrefix = true // TODO: нужно фиксить судя по всему
);
